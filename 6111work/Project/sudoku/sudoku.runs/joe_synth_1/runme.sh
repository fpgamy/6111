...
HD_PWD='/afs/athena.mit.edu/user/s/h/shreeyam/Documents/6.111/6111/6111work/Project/sudoku/sudoku.runs/joe_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log joe.vds -m64 -mode batch -messageDb vivado.pb -notrace -source joe.tcl
