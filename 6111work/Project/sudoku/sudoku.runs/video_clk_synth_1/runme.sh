...
HD_PWD='/afs/athena.mit.edu/user/s/h/shreeyam/Documents/6.111/sudoku/sudoku.runs/video_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_clk.vds -m64 -mode batch -messageDb vivado.pb -notrace -source video_clk.tcl
