...
HD_PWD='/afs/athena.mit.edu/user/s/h/shreeyam/Documents/6.111/6111/6111work/Project/sudoku/sudoku.runs/nine_16_d_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nine_16_d.vds -m64 -mode batch -messageDb vivado.pb -notrace -source nine_16_d.tcl
