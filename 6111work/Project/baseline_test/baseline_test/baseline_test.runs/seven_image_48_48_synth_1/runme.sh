...
HD_PWD='/afs/athena.mit.edu/user/s/h/shreeyam/Documents/6.111/6111/6111work/Project/baseline_test/baseline_test/baseline_test.runs/seven_image_48_48_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seven_image_48_48.vds -m64 -mode batch -messageDb vivado.pb -notrace -source seven_image_48_48.tcl
