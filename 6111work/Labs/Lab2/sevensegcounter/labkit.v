...
module labkit (beep, audio_reset_b, ac97_sdata_out, ac97_sdata_in, ac97_synch,
   ...
   defparam reset_shift_reg.INIT = 16'hFFFF;
	...
	// Generate a debounced version of the button input
	debounce #(.ACTIVE_HIGH_IN(0)) button_debouncer(
											.clk_in    (clock_27mhz),
	...
	// Assign the debounced signal to the input of a counter which counts from 0 to 9
	counter  #(.WIDTH(4)) single_hex_dig_count(
	...
	assign {user1[0], user1[1], user1[2], user1[3], user1[4], user1[5], user1[6]} = seven_seg_output;
endmodule
